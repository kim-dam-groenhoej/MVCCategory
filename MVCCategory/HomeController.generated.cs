...
namespace MVCCategory.Controllers
{
    public partial class HomeController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult TestTrykMig()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.TestTrykMig);
        }
        ...
        static readonly ActionParamsClass_TestTrykMig s_params_TestTrykMig = new ActionParamsClass_TestTrykMig();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_TestTrykMig TestTrykMigParams { get { return s_params_TestTrykMig; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_TestTrykMig
        {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : MVCCategory.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void TestTrykMigOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string test);

        [NonAction]
        public override System.Web.Mvc.ActionResult TestTrykMig(string test)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.TestTrykMig);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "test", test);
            TestTrykMigOverride(callInfo, test);
            return callInfo;
        }

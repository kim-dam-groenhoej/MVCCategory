...
namespace MVCCategory.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CategoryController : MVCCategory.Controllers.CategoryController
    {
        ...
        [NonAction]
        partial void GetCategoriesOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int id);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetCategories(int id)
        {
